...
import type { SaasButtonProps } from '@saas-core/shadcn-ui';
import type { ClassType, MaybeComputedRef } from '@saas-core/typings';
...
export interface ActionButtonOptions extends SaasButtonProps {
  [key: string]: any;
...
export type ExtendedFormApi = FormApi & {
  useStore: <T = NoInfer<SaasFormProps>>(
    selector?: (state: NoInfer<SaasFormProps>) => T,
  ) => Readonly<Ref<T>>;
};

export interface SaasFormAdapterOptions<
  T extends BaseFormComponentType = BaseFormComponentType,
> {
  config?: {
