...
import type { ClassType, Recordable } from '@saas-core/typings';

import type { TreeProps } from './types';

import { onMounted, ref, watchEffect } from 'vue';

import { ChevronRight, IconifyIcon } from '@saas-core/icons';
import { cn, get } from '@saas-core/shared/utils';
...
<template>
  <TreeRoot
    ...
    :class="
      cn(
        'text-blackA11 container list-none rounded-lg p-2 text-sm font-medium select-none',
